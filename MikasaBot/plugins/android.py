...
@bot.on(mikasa_cmd(pattern=r"magisk"))
...
@bot.on(mikasa_cmd(outgoing=True, pattern=r"device(?: |$)(\S*)"))
...
@bot.on(mikasa_cmd(outgoing=True, pattern=r"codename(?: |)([\S]*)(?: |)([\s\S]*)"))
...
@bot.on(mikasa_cmd(outgoing=True, pattern=r"specs(?: |)([\S]*)(?: |)([\s\S]*)"))
...
@bot.on(mikasa_cmd(outgoing=True, pattern=r"twrp(?: |$)(\S*)"))
