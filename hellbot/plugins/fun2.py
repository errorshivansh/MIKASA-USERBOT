...
@bot.on(mikasa_cmd(pattern="pat ?(.*)", outgoing=True))
...
@bot.on(mikasa_cmd(pattern="join$", outgoing=True))
...
@bot.on(mikasa_cmd(pattern="pay$", outgoing=True))
...
@bot.on(mikasa_cmd(pattern="climb$", outgoing=True))
...
@bot.on(mikasa_cmd(pattern="aag$", outgoing=True))
...
@bot.on(mikasa_cmd(pattern="push$", outgoing=True))
...
@bot.on(mikasa_cmd(pattern="work$", outgoing=True))
...
@bot.on(mikasa_cmd(pattern="suckit$", outgoing=True))
...
@bot.on(mikasa_cmd(pattern="ohh$", outgoing=True))
...
@bot.on(mikasa_cmd(pattern="lovestory$", outgoing=True))
...
@bot.on(mikasa_cmd(pattern="bf$", outgoing=True))
...
@bot.on(mikasa_cmd(pattern="session$", outgoing=True))
...
@bot.on(mikasa_cmd(pattern="ftext ?(.*)"))
...
@bot.on(mikasa_cmd(pattern="cat$"))
@bot.on(sudo_cmd(pattern="cat$", allow_sudo=True))
async def hmm(mikasa):
    if mikasa.fwd_from:
        return
    reactcat = nekos.textcat()
    await eor(mikasa, reactcat)


@bot.on(mikasa_cmd(pattern="why$"))
@bot.on(sudo_cmd(pattern="why$", allow_sudo=True))
async def hmm(mikasa):
    if mikasa.fwd_from:
        return
    whymikasa = nekos.why()
    await eor(mikasa, whymikasa)


@bot.on(mikasa_cmd(pattern="fact$"))
@bot.on(sudo_cmd(pattern="fact$", allow_sudo=True))
async def hmm(mikasa):
    if mikasa.fwd_from:
        return
    factmikasa = nekos.fact()
    await eor(mikasa, factmikasa)
