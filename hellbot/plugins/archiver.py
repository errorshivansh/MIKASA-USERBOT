...
@bot.on(mikasa_cmd(pattern="zip", outgoing=True))
...
@bot.on(mikasa_cmd(pattern="compress"))
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await bot.send_file(
                event.chat_id,
                directory_name + ".7z",
                caption="7z archived By MikasaBot",
                force_document=True,
                allow_cache=False,
                reply_to=event.message.id,
            )
...
@bot.on(mikasa_cmd(pattern="unzip"))
...
@bot.on(mikasa_cmd(pattern="unrar"))
...
@bot.on(mikasa_cmd(pattern="untar"))
