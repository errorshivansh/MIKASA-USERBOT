...
@bot.on(mikasa_cmd(pattern=r"tweet(?: |$)(.*)"))
...
async def nope(kraken):
    ...
    if not mikasa:
        if kraken.is_reply:
            ...
            return
    tweeter = await bot.inline_query("TwitterStatusBot", f"{(deEmojify(mikasa))}")
...
@bot.on(mikasa_cmd(pattern=r"trump(?: |$)(.*)"))
...
@bot.on(mikasa_cmd(pattern=r"modi(?: |$)(.*)"))
...
@bot.on(mikasa_cmd(pattern=r"mia(?: |$)(.*)"))
...
@bot.on(mikasa_cmd(pattern=r"dani(?: |$)(.*)"))
...
@bot.on(mikasa_cmd(pattern=r"pappu(?: |$)(.*)"))
...
@bot.on(mikasa_cmd(pattern=r"sunny(?: |$)(.*)"))
...
@bot.on(mikasa_cmd(pattern=r"johhny(?: |$)(.*)"))
...
@bot.on(mikasa_cmd(pattern=r"gandhi(?: |$)(.*)"))
...
@bot.on(mikasa_cmd(pattern=r"cmm(?: |$)(.*)"))
...
@bot.on(mikasa_cmd(pattern=r"kanna(?: |$)(.*)"))
