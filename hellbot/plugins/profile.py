...
@bot.on(mikasa_cmd(pattern="offline$", outgoing=True)) 
async def _(event):
    if event.fwd_from:
        return
    user_it = "me"
...
@bot.on(mikasa_cmd(pattern="online$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    user_it = "me"
...
@bot.on(mikasa_cmd(pattern="pbio (.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@bot.on(mikasa_cmd(pattern="pname (.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@bot.on(mikasa_cmd(pattern="ppic"))
async def _(event):
    if event.fwd_from:
        return
...
@bot.on(mikasa_cmd(outgoing=True, pattern="username (.*)"))
...
@bot.on(mikasa_cmd(outgoing=True, pattern="count$"))
...
@bot.on(mikasa_cmd(outgoing=True, pattern=r"delpfp"))
...
@bot.on(mikasa_cmd(pattern="myusernames$"))
async def _(event):
    if event.fwd_from:
        return
