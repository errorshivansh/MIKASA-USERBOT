...
BELLO = [
    ...
    '`"Teeth constantly require maintenance to prevent their decay when mikasa, and yet they manage to survive for thousands of years buried as fossils."`',
