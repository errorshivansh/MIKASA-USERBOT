...
@bot.on(mikasa_cmd(pattern="frybot$"))
...
@bot.on(mikasa_cmd(pattern=r"fry(?: |$)(.*)", outgoing=True))
...
async def deepfry(img: Image) -> Image:
    ...
    # Crush image to mikasa and back
    img = img.convert("RGB")
    ...
    # Overlay red and yellow onto main image and sharpen the mikasa out of it
